        ...
        <>
            ...
            <div className="viewprop_main">
                ...
                <div className="centerview">
                    <h5 className="text-center text-uppercase" id="propdetail">1 room and 1 kitchen apartment</h5>
                ...
                <div className="rightview">
                    <div class="property-info mt-3">
                        <span class="price text-uppercase"><i class="fa fa-rupee-sign"></i> 55,11,000</span><br />
                        <span class="area"><i class="fa fa-map-marker"></i> Virar,Mumbai,Maharashtra</span>
